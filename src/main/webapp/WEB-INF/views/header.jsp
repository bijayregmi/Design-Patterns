        ...
        <nav class="navbar-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a href="index.html">
                        <img src="${pageContext.request.contextPath}/resource/img/flex-admin-logo.png" data-1x="${pageContext.request.contextPath}/resource/img/flex-admin-logo@1x.png" data-2x="${pageContext.request.contextPath}/resource/img/flex-admin-logo@2x.png" class="hisrc img-responsive" alt="">
                    </a>
                </div>
            </div>
            <!-- end BRAND HEADING -->
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="${pageContext.request.contextPath}/resource/img/user-profile-1.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="${pageContext.request.contextPath}/resource/img/user-profile-2.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="${pageContext.request.contextPath}/resource/img/user-profile-3.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="${pageContext.request.contextPath}/resource/img/user-profile-4.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
